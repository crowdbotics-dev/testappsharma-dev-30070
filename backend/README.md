...
## Project Structure
    ...
    ├── testappsharma_dev_30070  # Django project configurations
...
1. Clone this repo and `cd testappsharma_dev_30070`
...
2. Clone this repo and `cd testappsharma_dev_30070`
